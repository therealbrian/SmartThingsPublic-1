...
class DynamicPlexMediaApi(
    ...
    override suspend fun getChildren(ratingKey: String) = api().getChildren(ratingKey)
    ...
    override suspend fun getMetadata(ratingKey: String) = api().getMetadata(ratingKey)
